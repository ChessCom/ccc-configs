...
ADD https://api.github.com/repos/jw1912/akimbo/git/refs/heads/main /.git-hashref

# ------------------------------------------------------------------------------

# Clone and build from main
RUN git clone https://github.com/jw1912/akimbo.git && \
    cd akimbo && \
    EVALFILE=resources/net.bin cargo rustc --release -- -C target-cpu=native

CMD [ "./akimbo/target/release/akimbo" ]
